...
<!-- Modal -->
<div class="modal fade" id="add_section" role="dialog" tabindex="-1" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">เพื่มฝ่าย </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span>&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="controller/department_add_section_save.php" id="myForm" method="post">
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="department_id" placeholder="" value="<?= $department_id ?>" class="form-control" />
                                </div>
                            </div>
                        </div>
    ...
    $('#btn_submit').on('click', function(e) {
        ...
        swal.fire({
            ...
            preConfirm: () => {
                ...
                $.ajax({
                    url: 'controller/department_add_section_save.php',
                    type: "post",
