...
require_once("../../../dashboard/StandAlone/config/dbconnect.php");
...
<?php  if ( $row_res["avatar_img"] != NULL ){
                                      echo '<img alt=""  class="rounded-circle img-center img-fluid shadow shadow-lg--hover"  src="../../../dashboard/StandAlone/public/fileupload/'.$row_res["avatar_img"].'">'; 
                                    } else{
                                      echo ' <img alt=""class="rounded-circle img-center img-fluid shadow shadow-lg--hover" src="../../../dashboard/StandAlone/assets/img/brand/bot.png">';
                                    }
                                    ?> 
</a>
