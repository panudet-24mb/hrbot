...
<!-- Modal -->
<div class="modal fade" id="canclemodal" role="dialog" tabindex="-1" aria-labelledby="exampleModalLabel">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="modal_confirm_leave_save.php" id="myForm" method="post">
                    <input type="hidden" class="form-control" name="type_post" value="1"> 
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                <h6>กรุณากรอกเหตุผล</h6>

                            </div>
                        </div>
                        <div class="col-md-10">
                            <div class="form-group">
                            <input type="text" class="form-control" name="leave_paper_confirm_reason">
                            </div>
                        </div>
